...
<html>
	<head>
        ...
        <script>
            ...
            {
               window.location="add_to_cart_veggie.jsp?product="+x;
            }
        </script>
        ...
        <centre>
       <div class="heading" style="width:50%;position:relative;margin-left:30%;margin-top:1%;">
           ...
           <a style="float:right;position:fixed;right:1%;top:6%" href="../../index.html">
               <img src="../images/logout.png" height="80" width="80"/>
              </a>
	 </div>
        </centre>
